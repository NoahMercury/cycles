...
KERNEL_STRUCT_MEMBER(film, int, pass_combined_rnm_0)
KERNEL_STRUCT_MEMBER(film, int, pass_combined_rnm_1)
KERNEL_STRUCT_MEMBER(film, int, pass_combined_rnm_2)
KERNEL_STRUCT_MEMBER(film, int, rnm_components)
